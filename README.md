...
The ComfyUI repository is checked periodically for updates, to ensure the images stay up to date. Last updated for each published image tag. Green = <24h, Yellow = <7d, Red = older.
