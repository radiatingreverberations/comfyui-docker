...
target "comfyui-base" {
    ...
    cache-from = ["type=gha,scope=comfyui-base"]
    cache-to   = ["type=gha,scope=comfyui-base,mode=max"]
}
...
target "comfyui-extensions" {
    ...
    platforms  = ["linux/amd64"]
    cache-from = ["type=gha,scope=comfyui-extensions"]
    cache-to   = ["type=gha,scope=comfyui-extensions,mode=max"]
}
...
target "comfyui-omnigen2" {
    ...
    platforms  = ["linux/amd64"]
    cache-from = ["type=gha,scope=comfyui-omnigen2"]
    cache-to   = ["type=gha,scope=comfyui-omnigen2,mode=max"]
}
